...
public class BookRestController {
	...
	public Book getBookById(@PathVariable Integer id) {
		return new Book(id, "Head First Java", 500);
	}

	@GetMapping("/all")
	public List<Book> getAll() {
		return List.of(new Book(501, "Head First Java", 439), new Book(502, "Spring in Action", 340), new Book(503, "Hibernate in Action", 355));
	}
